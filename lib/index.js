...
function ESP8266Window2(log, config) {
  this._log = log;
  ...
  if (this.window)
  { WINDOW_PATH = WINDOW_PATH + String(this.window)}
}

ESP8266Window2.prototype.identify = function (cb) {
  this._log('Identify requested');
  cb();
};

ESP8266Window2.prototype.setTargetPosition = function (value, cb) {
...
ESP8266Window2.prototype.getCurrentPosition = function (cb) {
...
ESP8266Window2.prototype.getPositionState = function (cb) {
...
ESP8266Window2.prototype.getServices = function () {
  var services = [];

  var informationService = new Service.AccessoryInformation();
  informationService
    .setCharacteristic(Characteristic.Manufacturer, "Shiba Inu/Uwe Klaus")
    .setCharacteristic(Characteristic.Model, "ESP8266 Window double")
...
module.exports = function (homebridge) {
  ...
  homebridge.registerAccessory("homebridge-esp8266-window2",
    "ESP8266Window2", ESP8266Window2);
};
